...
" Use Ctrl + Right/Left arrows to switch tabs
nnoremap <C-l> :bnext<CR>
nnoremap <C-h> :bprevious<CR>

" Or use Leader + n/p (standard for many vim users)
...
highlight BufTabLineCurrent ctermbg=yellow ctermfg=black
" Change the color of the background tabs
highlight BufTabLineHidden ctermbg=black ctermfg=white
